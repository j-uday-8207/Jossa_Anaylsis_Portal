      ...
      <div className="container">
        ...
        <div className="content">
          ...
          <div className="filters">
            <h3>Filters:</h3>
            <p>Program: {choiceData.program}</p>
            <p>Year: {choiceData.year}</p>
            <p>Seat Type: {choiceData.seatType}</p>
            <p>Gender: {choiceData.gender}</p>
            <p>Round: {choiceData.round}</p>
            <p>Rank: {choiceData.rank}</p>
          </div>
